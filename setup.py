...
setup(
    name="domain-manager-cli",
    # Versions should comply with PEP440
    version=get_version("src/dmcli/_version.py"),
    description="Domain Manager Library and CLI",
    ...
    project_urls={
        "Source": "https://github.com/cisagov/domain-manager-cli",
        "Tracker": "https://github.com/cisagov/domain-manager-cli/issues",
    },
    # Author details
