...
def test_domain_categorize_command(mocker):
    """Test `dmcli domain categorize`."""
    mocker.patch(
        "dmcli.utils.api.get",
        return_value={"name": "example.com"},
    )
...
def test_domain_generate(mocker):
    """Test `dmcli domain generate`."""
    mocker.patch(
        "dmcli.utils.api.get",
        return_value={
            "name": "example.com",
