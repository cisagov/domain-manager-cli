...
class TestTrendmicro():
  ...
  def test_trendmicro(self):
    ...
    self.driver.find_element(By.ID, "urlname").click()
    self.driver.find_element(By.ID, "urlname").send_keys("http://testingaccount.xyz/")
    self.driver.find_element(By.ID, "getinfo").click()
    self.driver.find_element(By.ID, "myBtn").click()
    self.driver.find_element(By.CSS_SELECTOR, ".modal_content_2:nth-child(2) a").click()
    self.driver.find_element(By.CSS_SELECTOR, ".lightbg:nth-child(4) input").click()
    self.driver.find_element(By.CSS_SELECTOR, ".suggestoption > .radioinput").click()
    ...
    time.sleep(1)
    self.driver.find_element(By.CSS_SELECTOR, "#Business .child_row_01:nth-child(3) .radio_c1").click()
    self.driver.find_element(By.ID, "owner").click()
    self.driver.find_element(By.ID, "comments").click()
    self.driver.find_element(By.ID, "comments").send_keys("Changing Website for customer")
    self.driver.find_element(By.ID, "textfieldemail").send_keys("barry.k.hansen@gmail.com")    
